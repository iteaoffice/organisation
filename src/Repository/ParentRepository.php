 ...
 */
final class ParentRepository extends EntityRepository implements FilteredObjectRepository
{
    public function findFiltered(array $filter = []): QueryBuilder
    {
        $queryBuilder = $this->_em->createQueryBuilder();
        $queryBuilder->select('organisation_entity_parent');
        $queryBuilder->from(Entity\ParentEntity::class, 'organisation_entity_parent');
        ...
        $queryBuilder->andWhere(
            $queryBuilder->expr()->orX(
                $queryBuilder->expr()->eq(
                    ...
                    Entity\ParentEntity::MEMBER_TYPE_MEMBER
                ),
                $queryBuilder->expr()
                    ->notIn(
    ...
    public function findActiveParentWhichAreNoMember(array $filter): QueryBuilder
    {
        ...
        //Exclude the members
        $queryBuilder->andWhere(
            $queryBuilder->expr()->neq('organisation_entity_parent.memberType', Entity\ParentEntity::MEMBER_TYPE_MEMBER)
        );
    ...
    public function limitCChambers(QueryBuilder $queryBuilder): QueryBuilder
    {
        ...
        $subSelect->from(Entity\ParentEntity::class, 'organisation_entity_parent_c_chamber');
        ...
        $queryBuilder->setParameter('memberType', Entity\ParentEntity::MEMBER_TYPE_MEMBER);
    ...
    public function limitFreeRiders(QueryBuilder $queryBuilder, Program $program): QueryBuilder
    {
        ...
        $subSelect->from(Entity\ParentEntity::class, 'organisation_entity_parent_freerider');
        ...
        $queryBuilder->setParameter('memberType', Entity\ParentEntity::MEMBER_TYPE_NO_MEMBER);
        $queryBuilder->setParameter('epossMemberType', Entity\ParentEntity::EPOSS_MEMBER_TYPE_NO_MEMBER);
        $queryBuilder->setParameter('artemisiaMemberType', Entity\ParentEntity::ARTEMISIA_MEMBER_TYPE_NO_MEMBER);
        ...
        $doaSubselect->from(Entity\ParentEntity::class, 'organisation_entity_parent_doa');
