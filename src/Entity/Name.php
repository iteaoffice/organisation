...
{
    /**
     * @ORM\Column(name="name_id", length=10, type="integer", nullable=false)
     * @ORM\Id
    ...
    private $dateCreated;
    /**
     * @ORM\OneToOne(targetEntity="Project\Entity\Project", inversedBy="organisationName", cascade={"persist"})
     * @ORM\JoinColumns({
